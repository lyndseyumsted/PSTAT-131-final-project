...
Here we can see that there was a rise in cases around weeks 26 to 35 which are the months June through August and then there is another spike following week 46 which is about halfway through November to the rest of the year right around the winter holidays when more people stayed indoors and possibly had larger gatherings than just immediate households.
...
The fifth model I trained was a Single Decision Tree. Here is how I fit the model and used cross-validation to tune the cost_complexity() parameter:
...
We can look at the Random Forest Variable Importance Plot:
...
We can look at the XGBoost Variable Importance Plot:
...
These results may appear to be excellent se to remember that this model was trained on 80% of the original data set so this is what is known as overfitting
