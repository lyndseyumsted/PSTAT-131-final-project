...
There is some class imbalance with only 28% of the observations being categorized as high risk, so all models will be stratified on this variable to avoid any prediction problems.
...
pandemic_cum <- pandemic_cum %>%
  dplyr::select(-c("prop", "confirmed_cases", "population", "ID_co", "proplog"))
