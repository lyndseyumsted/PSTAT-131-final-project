...
![](https://s.abcnews.com/images/US/mask-new-orleans_hpMain_20200720-015335_16x9_992.jpg)
...
![](https://www.familydocs.org/wp-content/uploads/2020/03/coronavirus.jpg)
...
I then fit the LDA model to the entire training set and evaluated its performance by looking at the following:
...
I then fit the QDA model to the entire training set and evaluated its performance by looking at the following:
...
I then fit the Naive Bayes model to the entire training set and evaluated its performance by looking at the following:
...
I then fit the K-Nearest Neighbor model to the entire training set and evaluated its performance by looking at the following:
...
For the Random Forest model, the top three most important predictor variables were Hispanic\_., Education, and Mean_Tmax.
...
-   Note:
    ...
    -   `learn_rate()` is a hyper-parameter used to control how fast the model learns and determines the step size at each iteration while moving toward a minimum of a loss function.
...
For the XGBoost model, the top three most important predictor variables were under_10\_., Education, and Mean_Tmax.
...
The Bagged Tree model had the highest accuracy of 1.00, followed by XGBoost with an accuracy of 0.9902280, followed by Random Forest with an accuracy of 0.9685125, and a Single Decision Tree with an accuracy of 0.8241042.
